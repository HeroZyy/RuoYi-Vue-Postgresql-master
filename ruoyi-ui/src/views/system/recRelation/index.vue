<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="relationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="场景编号" align="center" prop="sid" />
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除场景关联编号为"' + sids + '"的数据项？').then(function() {
        return delRelation(sids);
      }).then(() => {
        this.getList();
